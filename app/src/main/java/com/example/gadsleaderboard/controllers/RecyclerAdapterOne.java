...
public class RecyclerAdapterOne extends RecyclerView.Adapter<RecyclerAdapterOne.RecyclerViewHolder> {

    private Context mContext;
    private ArrayList<LearnerOne> mLearnerOneList;

    public RecyclerAdapterOne(Context context, ArrayList<LearnerOne> learnerOneList) {
        mContext = context;
